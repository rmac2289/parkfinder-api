  ...
  return db.transaction((trx) =>
    trx
      ...
      .then(() =>
        Promise.all([
          trx.raw(
            `ALTER SEQUENCE parkfinder_users_id_seq minvalue 0 START WITH 1`
          ),
          trx.raw(
            `ALTER SEQUENCE parkfinder_suggestions_id_seq minvalue 0 START WITH 1`
          ),
          trx.raw(
            `ALTER SEQUENCE parkfinder_comments_id_seq minvalue 0 START WITH 1`
          ),
...
function seedUsers(db, users) {
  ...
  return db
    ...
    .then(() =>
      ...
      db.raw(`SELECT setval('parkfinder_users_id_seq', ?)`, [
...
function seedSuggestions(db, suggestions) {
  ...
  return db
    ...
    .insert(preppedSuggestions)
    .then(() =>
      db.raw(`SELECT setval('parkfinder_suggestions_id_seq', ?)`, [
...
function seedCommentsTables(db, users, comments) {
  ...
  return db.transaction(async (trx) => {
    ...
    await trx.raw(`SELECT setval('parkfinder_comments_id_seq', ?)`, [
